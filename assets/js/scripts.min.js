+function(a) {
    ...
    a.fn.wrapChildren = function(b) {
        ...
        return void 0 === b.childElem ? this : this.each(function() {
            var c = a(this).children(b.childElem), d = [];
            c.each(function(e, f) {
                if (d.push(f), (e + 1) % b.sets === 0 || e === c.length - 1) {
                    var g = a(d);
                    d = [], g.wrapAll(a(b.wrapper));
                }
            });
        });
    };
        ...
        _placeholder_shim: function(b) {
            ...
            return this.each(function() {
                ...
                if (e.is(":visible")) {
                    ...
                    e.data("placeholder", j).keydown(function() {
                        j.hide();
                    }).blur(function() {
